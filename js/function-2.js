...
var budgetController = (function() {
    ...
    return {
        ...
        filterData: function(filterObj) {
            ...
            var date;
            date = new Date(filterObj.resp).getTime();
            ...
            if (filterObj.type == 'single-date') {
                ...
                startDate = new Date(filterObj.resp[0]).getTime();
                endDate = new Date(filterObj.resp[1]).getTime();
...
var UIController = (function() {
    ...
    return {
        ...
        updateRecordTitle: function(label) {
            ...
            if (label == 'Remove') {
                document.querySelector(DOMstrings.budgetTitle).innerHTML = 'All Records:';
            } else {
...
var mainController = (function(budgetCtrl, uiCtrl) {
    ...
    var setupEventListeners = function() {
        ...
        // Record options
        $(DOM.record).click(function(e) {
            $(DOM.record).removeClass('active');
        ...
        var ctrlApplyFilter = function(e, value) {
            ...
            // var filterRec = $(DOM.recordActive).attr("data-value");
            var filterDate = $(DOM.dateActive).attr("data-value");
            var filterRes = budgetCtrl.setFilterType(filterDate);
    ...
    var loadNewList = function(listObj) {
        ...
        // console.log('Results for: ' + listObj.date);
